...
const Copy ar = (
  tabs: ['البريد', 'الفرجة', 'الجهاز'],
  pick: 'اختار رسالة',
  reply: 'ردّ',
  forward: 'حوّلها',
  toMe: 'إلي',
  body:
      'طبّگ الموبايل والرسالة تبقى مفتوحة. افتحه وترجع القائمة يمها، '
      'بنفس المكان اللي وگفت بي.',
  compose: 'رسالة جديدة',
  to: 'إلى',
  send: 'دز',
  close: 'سد',
  ...
  mails: [
    (
      from: 'سارة حداد',
      subject: 'نسخة Duo خلصت',
      preview: 'كل الاختبارات نجحت عالمحاكي، الليلة ننزلها.',
      time: '9:41',
      unread: true,
    ),
    (
      ...
      preview: 'شريط التنقل يمشي ويه التطبيق اليسار، نفس الأشرطة الأصلية.',
      time: '9:12',
      unread: true,
    ),
    (
      from: 'لينا ناصر',
      subject: 'نتايج اختبار الطبگة',
      preview: 'ماكو ولا زر هسه يوگع على الطبگة. الصور بالمرفقات.',
      time: '8:55',
      unread: false,
    ),
    (
      from: 'يوسف أمين',
      subject: 'ملاحظات إصدار 1.0',
      preview: 'المسودة حاضرة، تگدر تضيف قسم ملاءمة الفيديو؟',
      time: 'البارحة',
      unread: false,
    ),
    (
      from: 'مايا سعيد',
      subject: 'أفكار لوضع الميز',
      preview: 'الفيديو فوگ والأزرار بالنص الجوة. تحسها طبيعية.',
      time: 'البارحة',
      unread: false,
    ),
    (
      from: 'آدم يوسف',
      subject: 'غدا يوم الخميس؟',
      preview: 'اكو مطعم جديد يم الدائرة، الشاورما مالته تخبل.',
      time: 'الاثنين',
      unread: false,
    ),
    (
      ...
      preview: 'عجبتني التخطيطات بشكل الجواز، عندي كم ملاحظة عالمسافات.',
      time: 'الاثنين',
      unread: false,
    ),
    (
      from: 'أحمد العلي',
      subject: 'موبايلات أندرويد اللي تنطبگ',
      preview: 'لمن تفتح الجهاز نص فتحة، اللوحات تنگسم بالضبط عالمفصل.',
      time: 'الأحد',
      unread: false,
    ),
  ],
